  ...
  <div class="global">
			...
			<div class="log log_in" tabindex='-1' id='dl'>
				<dl>
					...
					<dt>
						<div class='letter'>
							用户名:&nbsp;<input type="text" name="userid" id="userid" tabindex='1'/>
						</div>
					</dt>
					<dt>
						<div class='letter'>
							密&nbsp;&nbsp;&nbsp;码:&nbsp;<input type="password" name="pwd" id="pwd" tabindex='2'/>
						</div>
					</dt>
					<dt>
						<div class='letter'>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="Pt1" value="用户" checked="checked"/>用户
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="Pt1" value="管理员"/>管理员
						</div>
					</dt>
					<dt>
						<div>
			...
			<div class="sig sig_out" tabindex='-1' id='zc' style='visibility:hidden;'>
				<dl>
					...
					<dt>
						<div class='letter'>
							用户名:&nbsp;<input type="text" name="userid" id="regist_username" tabindex='5'/>
							<div class='warning' id='warning_1'><span>该用户名不可用</span></div>
						</div>
					</dt>
					<dt>
						<div class='letter'>
							昵&nbsp;&nbsp;&nbsp;称:&nbsp;<input type="text" name="username" id="nickname" tabindex='6'/>
						</div>
					</dt>
					<dt>
						<div class='letter'>
							密&nbsp;&nbsp;&nbsp;码:&nbsp;<input type="password" name="userpd1" id="regist_password" tabindex='7'/>
							<div class='warning' id='warning_2'><span>密码长度过短</span></div>
						</div>
					</dt>
					<dt>
						<div class='password'>
							&nbsp;&nbsp;&nbsp;确认密码:&nbsp;<input type="password" name="userpd2" id="final_password" tabindex='8'/>
